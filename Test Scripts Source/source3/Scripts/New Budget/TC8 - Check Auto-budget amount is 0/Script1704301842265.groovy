...
WebUI.setText(findTestObject('Object Repository/Page Create new budget/input_Name_name'), 'abc')
...
TestObject errorMessageTo = findTestObject('Object Repository/Page Create new budget/p_The value must be more than zero')
