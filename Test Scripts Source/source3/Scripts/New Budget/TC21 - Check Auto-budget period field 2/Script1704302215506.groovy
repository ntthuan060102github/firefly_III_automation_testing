...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page Create new budget/auto_budget_period_input new budget'), 
    'half_year', true)

// Verify the input field value
TestObject inputFieldTo = findTestObject('Object Repository/Page Create new budget/auto_budget_period_input new budget')
String expectedValue = 'half_year'
