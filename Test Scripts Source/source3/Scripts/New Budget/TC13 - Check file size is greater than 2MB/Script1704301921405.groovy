...
WebUI.setText(findTestObject('Object Repository/Page Create new budget/input_Name_name'), 'oldname')

TestObject fileInput = findTestObject('Object Repository/Page Create new budget/file_attachments_input new budget')
