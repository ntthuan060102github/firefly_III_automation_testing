...
WebUI.setText(findTestObject('Object Repository/Page Create new budget/input_Name_name'), 'Car')

WebUI.click(findTestObject('Object Repository/Page Create new budget/button_Store new budget'))

TestObject errorMessageTo = findTestObject('Object Repository/Page Create new budget/p_This name is already in use')
