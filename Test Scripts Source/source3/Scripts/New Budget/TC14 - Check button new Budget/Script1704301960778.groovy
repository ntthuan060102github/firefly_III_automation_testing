...
WebUI.setText(findTestObject('Object Repository/Page Create new budget/input_Name_name'), 'hihihi')

WebUI.click(findTestObject('Object Repository/Page Create new budget/button_Store new budget'))

TestObject successMessageTo = findTestObject('OObject Repository/Page_Whats playing  Firefly III/div_CloseSuccessStored new budget')
