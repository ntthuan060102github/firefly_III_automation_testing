...
WebUI.setText(findTestObject('Object Repository/Page Create new budget/input_Name_name'), 'test')

// Verify the input field value
TestObject inputFieldTo = findTestObject('Object Repository/Page Create new budget/input_Name_name')
