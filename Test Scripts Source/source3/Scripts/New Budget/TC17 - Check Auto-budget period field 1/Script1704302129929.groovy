...
// Verify the clickability of the option input
WebUI.verifyElementNotClickable(findTestObject('Object Repository/Page Create new budget/auto_budget_period_input new budget'))
