...
WebUI.setText(findTestObject('Object Repository/Page Create new budget/input_Name_name'), 'fff')
...
TestObject errorMessage = findTestObject('Object Repository/Page Create new budget/p_The auto budget amount must be less than _50a2a2')
