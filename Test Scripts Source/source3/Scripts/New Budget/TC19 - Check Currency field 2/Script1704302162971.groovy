...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page Create new budget/Currency_input new budget'), 
    '1', true)

TestObject inputFieldTo = findTestObject('Object Repository/Page Create new budget/Currency_input new budget')
