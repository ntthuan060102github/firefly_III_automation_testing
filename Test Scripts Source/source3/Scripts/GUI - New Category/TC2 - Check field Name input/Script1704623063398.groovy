...
WebUI.setText(findTestObject('Object Repository/Page Create new category/input_Name_name'), 'hhhh')

// Verify the input field value
TestObject inputFieldTo = findTestObject('Object Repository/Page Create new category/input_Name_name')
