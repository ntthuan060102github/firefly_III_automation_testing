...
actual_repeats = WebUI.getAttribute(findTestObject('Object Repository/Page Create new budget/auto_budget_input new budget'), 
    'value', FailureHandling.STOP_ON_FAILURE)

WebUI.verifyEqual(actual_repeats, '1')
